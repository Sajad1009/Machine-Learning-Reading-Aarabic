    ...
    while True:
        ...
        if frame_count % 5 == 0:
            ...
            if score > .5:
                ...
                if human_string_n == "spatula":
                    human_string_n = "fork"
                if human_string_n == "water bottle":
                    human_string_n = "بطل ماء"
                if human_string_n == "pillow":
                    human_string_n = "وسادة"
                if human_string_n == "orange":
                    human_string_n = "برتقالة"
                if human_string_n == "iPod":
                   human_string_n = ",موبايل ايفون"
        ...
        if last > 40 and pygame.mixer.music.get_busy(
            ...
            if not os.path.isfile(name):
                tts = gTTS(text="أهلا بك ألعبادي .. يمكنني ان أرى  " + human_string, lang='ar')
                tts.save(name)
